...
| 3 | SEC RAG pipeline | Implemented: ingestion, hybrid keyword plus vector retrieval (PostgreSQL full-text and pgvector candidates fused by reciprocal rank, on by default since 2026-09-12: hit@5 0.633333 against 0.600000 vector-only on the 30-question set, snapshots 34 and 35), rebuild workflow ([RAG.md](documentation/RAG.md)) |
