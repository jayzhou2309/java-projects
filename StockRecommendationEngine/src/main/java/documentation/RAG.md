...
* FilingRetrievalProperties
    ...
    * Defaults
        ...
        * rrf-keyword-weight: 1.0 (weight of the keyword ranking).
        * rrf-figure-weight: 0.0 (weight of the figure ranking, chunks holding every number in the query; 0 leaves that leg off, the default until it is measured, RAG-12).
    * Validation
